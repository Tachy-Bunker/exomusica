  ...
  app.get("/api/site-settings", async () => {
    const settings = await prisma.siteSettings.findUnique({
      ...
      select: {
        ...
        faviconUrl: true,
        ogHomepageTitle: true,
        ogHomepageDescription: true,
        ogHomepageImageUrl: true,
        ogBranchDefaultTitle: true,
        ogBranchDefaultDescription: true,
        ogBranchDefaultImageUrl: true,
        ogAlbumDefaultTitle: true,
        ogAlbumDefaultDescription: true,
        ogAlbumDefaultImageUrl: true,
        ogWikiDefaultTitle: true,
        ogWikiDefaultDescription: true,
        ogWikiDefaultImageUrl: true,
        ogNewsDefaultTitle: true,
        ogNewsDefaultDescription: true,
        ogNewsDefaultImageUrl: true,
    ...
    return (
      settings ?? {
        ...
        faviconUrl: null,
        ogHomepageTitle: null,
        ogHomepageDescription: null,
        ogHomepageImageUrl: null,
        ogBranchDefaultTitle: null,
        ogBranchDefaultDescription: null,
        ogBranchDefaultImageUrl: null,
        ogAlbumDefaultTitle: null,
        ogAlbumDefaultDescription: null,
        ogAlbumDefaultImageUrl: null,
        ogWikiDefaultTitle: null,
        ogWikiDefaultDescription: null,
        ogWikiDefaultImageUrl: null,
        ogNewsDefaultTitle: null,
        ogNewsDefaultDescription: null,
        ogNewsDefaultImageUrl: null,
