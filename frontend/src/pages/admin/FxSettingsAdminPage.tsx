...
const SLIDERS: { key: keyof FxSettings; label: string; min: number; max: number; step: number }[] = [
  ...
  { key: "staticAmt", label: "Static snow", min: 0, max: 1, step: 0.01 },
  { key: "staticSpeed", label: "Static speed", min: 0, max: 1, step: 0.01 },
  { key: "vignette", label: "Vignette", min: 0, max: 1, step: 0.01 },
  { key: "caInitial", label: "Aberration initial", min: 0, max: 1, step: 0.01 },
  { key: "caBurst", label: "Aberration burst", min: 0, max: 1, step: 0.01 },
